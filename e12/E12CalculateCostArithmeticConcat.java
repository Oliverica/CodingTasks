...
public class E12CalculateCostArithmeticConcat {
    public static void main(String[] args) {
        ...
        String avarageCostString = String.format("%.3f", averageCost);

        // Print the results
        //  System.out.println("The total cost is " + totalCost);
        //System.out.println("The average cost is " + averageCost);

        System.out.println("The total cost is " + totalCostString);

        System.out.println("The avarage cost is " + avarageCostString);
