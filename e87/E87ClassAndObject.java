...
public class E87ClassAndObject {
    public static void main(String[] args) {
        ...
        System.out.println("Car color is " + car1.carColor + ", car year is " + car1.carYear + ", car make is " + car1.carMake);
        System.out.println("Car color is " + car2.carColor + ", car year is " + car2.carYear + ", car make is " + car2.carMake);
    }
}
